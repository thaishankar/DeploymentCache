...
namespace CacheClient
{
    class Program
    {
        ...
        //    contentCache.AddSiteToCache(cacheRequest.SiteName, Path.Combine(cacheRequest.StorageVolumePath, cacheRequest.RootDirectory));

        //    contentCache.RefreshSiteContents(cacheRequest.SiteName, Path.Combine(cacheRequest.StorageVolumePath, cacheRequest.RootDirectory)); ;
